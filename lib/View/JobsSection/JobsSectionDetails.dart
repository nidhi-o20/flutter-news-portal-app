...
class JobsSectionDetails extends StatefulWidget {
  DocumentSnapshot snapshot;

  JobsSectionDetails({this.snapshot});

  @override
  _JobsSectionDetailsState createState() => _JobsSectionDetailsState();
}

class _JobsSectionDetailsState extends State<JobsSectionDetails> {
  @override
