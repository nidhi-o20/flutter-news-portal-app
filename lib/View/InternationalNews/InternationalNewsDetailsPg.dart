...
class InternationalNewsDetails extends StatefulWidget {
  DocumentSnapshot snapshot;

  InternationalNewsDetails({this.snapshot});

  @override
  _InternationalNewsDetailsState createState() => _InternationalNewsDetailsState();
}

class _InternationalNewsDetailsState extends State<InternationalNewsDetails> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        shape: RoundedRectangleBorder(
          borderRadius: BorderRadius.only(bottomLeft:Radius.elliptical(40,40),
